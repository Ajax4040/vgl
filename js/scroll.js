window.smoothScroll = (function (window, document, undefined) {
    ...
    let _getDataOptions = function (options) {
      ...
      if (options === null || options === undefined) {
        ...
        options = options.split(';'); // Split into an array of options
    ...
    let animateScroll = function (toggle, anchor, options, event) {
      ...
      // Stop the scroll animation when it reaches its target (or the bottom/top of the page)
      // Private method
      // Runs functions
      let _stopAnimateScroll = function (position, endLocation, animationInterval) {
        ...
        if (position == endLocation || currentLocation == endLocation || ((window.innerHeight + currentLocation) >= document.body.scrollHeight)) {
          ...
          options.callbackAfter(toggle, anchor); // Run callbacks after animation completes
        }
      };
      ...
      // Reset the position to fix a weird iOS bug
